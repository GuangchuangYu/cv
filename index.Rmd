...
Professor and dean of the Department of Bioinformatics, School of Basic Medicine, Southern Medical University. My research group has been focusing on the development and application of bioinformatics methods and tools, and has developed a number of widely recognized bioinformatics tools in phylogeny, omics data analysis, and data visualization to help biologists explore and understand data. 
...
::: aside
![](figures/2022-highly-cited-researcher.png){width=100%}

![](figures/2021-highly-cited-researcher.jpg){width=100%}
...
::: aside
![](figures/treedata-jd-top1.jpg){width=100%}
:::
