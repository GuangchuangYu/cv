...
![logo](gc.png){width=100%}

```{r}
# When in export mode the little dots are unaligned, so fix that. 
if(PDF_EXPORT){
  cat("View this CV online with links at _guangchuangyu.github.io/resume_")
}
```
...
```{r, results='asis'}
selected_pkgs <- paste0(Biocpkg("clusterProfiler"), ", ", 
      Biocpkg("ChIPseeker"), ", ",
      Biocpkg("treeio"), " and ",
      Biocpkg("ggtree"))

intro_text <- paste0('Professor of Bioinformatics at [Southern Medical University](http://www.smu.edu.cn/). I have developed more than 20 R packages, including ',
  selected_pkgs, ".")
